...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"> <frame src="/admin/inc/head.html"
...
<!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
	...
	src="/admin/inc/left.html" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="/admin/inc/main.html" name="main" scrolling="yes" noresize="noresize"
